...
type NodeConfig* {.requiresInit, deprecated: "Use WakuNodeConf from tools/confutils/cli_args instead".} = object
  mode: WakuMode
...
proc toWakuConf*(nodeConfig: NodeConfig): Result[WakuConf, string] {.deprecated: "Use WakuNodeConf.toWakuConf instead".} =
...
proc decodeNodeConfigFromJson*(
    jsonStr: string
): NodeConfig {.raises: [SerializationError], deprecated: "Use WakuNodeConf with fieldPairs-based JSON parsing instead".} =
